...
public partial class UserControls_MessageUserControl : System.Web.UI.UserControl
{
    ...
    ///<summary>
    ///Handles a customer BusinessRules Exception by displaying the details and the general error.
    ///</summary>
    ///<param name="ex"></param>
    private void HandleException(BusinessRuleException ex)
    {
        ...
        ShowExceptions(details, ex.Message, STR_TEXT_ValidationErrors, STR_TITLE_ICON_warning, STR_PANEL_danger);
    }
    /// <summary>
